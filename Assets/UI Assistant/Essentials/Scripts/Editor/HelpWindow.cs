...
namespace UIAssistant
{
    public class HelpWindow : SettingsWindow
    {
        ...
        readonly GUIContent PayPalContent = new("Donate (PayPal)", PayPalLink);
        const string PayPalLink = "https://www.paypal.com/donate/?hosted_button_id=3LCPSPT2GEF34";
        readonly GUIContent EmailContent = new("Email", $"Copy to blipboard:\n{Email}");
